...
All of the examples in this section assume that you are using custom deprecation warnings classes within your app to help manage deprecations, so it might be best for you to start by reading :doc:`using-custom-warning-classes`.
...
3. A single setting replacement
===============================
...
4. A multiple setting replacement
=================================
